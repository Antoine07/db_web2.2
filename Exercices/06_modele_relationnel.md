...
CREATE TABLE planes (
  plane CHAR(4) NOT NULL,
  model VARCHAR(50) NOT NULL,
  CONSTRAINT pk_planes PRIMARY KEY (plane)
);

CREATE TABLE pilots (
  certificate CHAR(4) NOT NULL,
  name VARCHAR(100) NOT NULL,
  plane_id CHAR(4) NULL,
  CONSTRAINT pk_pilots PRIMARY KEY (certificate),
  CONSTRAINT fk_pilots_plane
    FOREIGN KEY (plane_id)
    REFERENCES planes(plane)
    ON DELETE SET NULL
    ON UPDATE CASCADE
);

INSERT INTO planes (plane, model) VALUES
  ('A320', 'Airbus A320'),
  ('B737', 'Boeing 737');

INSERT INTO pilots (certificate, name, plane_id) VALUES
