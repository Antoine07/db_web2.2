// Seed MongoDB for the `shop` database (fil rouge e-commerce).
// Usage (from repo root, in mongosh):
//   load("data/shop_mongodb_seed.js");
//   use("shop");
//
// Notes:
// - The IDs are fixed to make exercises reproducible.
// - Dates are stored as real ISODate values.
